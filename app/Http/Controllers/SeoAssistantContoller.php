...
class SeoAssistantContoller extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $add->projects_meta_title = $request->projects_meta_title ; 
        $add->projects_meta_desc = $request->projects_meta_desc ; 
        ...
        $add->career_meta_title = $request-> career_meta_title;
        $add->career_meta_desc = $request-> career_meta_desc;
        $add->career_meta_robots = $request-> career_meta_robots;
        $add->save();
