...
class MenuItemController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if($menuItem){       
            ...
            }elseif($menuItem->type == 'blogs'){
                $values = BlogItem::get();
            }elseif($menuItem->type == 'project'){
                $values=Project::get();
            }elseif($menuItem->type == 'service'){
                $values=Service::get();
            }elseif($menuItem->type == 'home' || $menuItem->type == 'about-us' || $menuItem->type == 'contact-us' || $menuItem->type =='board-of-members' || $menuItem->type == 'main-item' || $menuItem->type == 'projects' || $menuItem->type == 'services' || $menuItem->type == 'galleryImages' || $menuItem->type == 'galleryVideos'||$menuItem->type == 'certificates'){
                $values=[];
