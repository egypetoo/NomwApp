@extends('layouts.app') 
    <title>500 {{trans('home.server_error')}}</title>
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-item">
                    <h2 class="title">404 {{trans('home.server_error')}}</h2>
                </div>  
            </div>
        </div>
    </div>
...
<section id="errors">
     <div class="text-center">
        <img src="{{url('resources/assets/front/images/500.png')}}" width="600px" height="600px"/>
    </div>
    <div class="text-center">
