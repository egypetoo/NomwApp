                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="form-group col-md-4"> 
                                            ...
                                            <select class="form-control select2 menu_type" name="menu_type" required>
                                                ...
                                                <option value="indvidual-registration/login">{{trans('home.about-us')}}</option>
                                                ...
                                                <option value="career">{{trans('home.career')}}</option>
                                                ...
                                                <option value="certificates">{{trans('home.certificates')}}</option>
                                                <option value="company-registration/login">{{trans('home.galleryVideos')}}</option>
