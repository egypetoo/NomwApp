...
@section('meta')
    <title>{{trans('home.galleryVideos_dashboard')}}</title>
@endsection
@section('content')
        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.galleryVideos_dashboard')}}</li>
                </ol>
            </div>
        ...
        <div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="card custom-card">
					<div class="card-body">
						<div>
							<h6 class="card-title mb-1">{{trans('home.galleryVideos_dashboard')}}</h6>
                                ...
                                <tbody class="sortable">
                                    @foreach($galleryVideos as $galleryVideo)
                                        <tr id="{{$galleryVideo->id}}" data-id="{{ $galleryVideo->id }}"  class="image">
                                            ...
                                            <td><a href="{{ route('gallery-videos.edit', $galleryVideo->id) }}">{{$galleryVideo->name_ar}}</a></td>
                                            <td><a href="{{ route('gallery-videos.edit', $galleryVideo->id) }}">{{$galleryVideo->position_ar}}</a></td>
